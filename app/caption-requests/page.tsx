...
export default function CaptionRequests() {
  ...
  async function checkAndFetch() {
    ...
    const res = await fetch("/api/caption-requests")
  ...
  return (
    <main className="min-h-screen bg-gray-950 p-8">
      ...
      <h1 className="text-3xl font-black text-white mb-8">📝 Caption Requests</h1>
      <AdminTable title="Caption Requests" emoji="📝" data={data} columns={["id", "profile_id", "image_id", "created_datetime_utc"]} />
    </main>
  )
}