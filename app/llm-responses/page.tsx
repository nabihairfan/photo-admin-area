...
export default function LLMResponses() {
  ...
  async function checkAndFetch() {
    ...
    const res = await fetch("/api/llm-responses")
  ...
  return (
    <main className="min-h-screen bg-gray-950 p-8">
      ...
      <h1 className="text-3xl font-black text-white mb-8">💬 LLM Responses</h1>
      <AdminTable title="LLM Responses" emoji="💬" data={data} columns={["id", "llm_model_id", "processing_time_seconds", "caption_request_id", "created_datetime_utc"]} />
    </main>
  )
}