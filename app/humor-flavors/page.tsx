...
export default function HumorFlavors() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 p-8">
      ...
      <h1 className="text-3xl font-black text-white mb-8">😂 Humor Flavors</h1>
      <AdminTable title="Humor Flavors" emoji="😂" data={data} columns={["id", "slug", "description", "created_datetime_utc"]} />
    </main>
  )
}